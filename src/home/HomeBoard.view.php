<div class="homeboard">
    <div class="mb-3">
        <a  title="BlackFriday 40% OFF Both KoolReport Pro and Dashboard Framework" 
            href="https://www.koolreport.com/koolreport-pro-pricing?pcode=blackfriday2023#choose-your-license" 
            style="padding:0px;text-decoration: none;">
            <img class="img-fluid rounded d-none d-sm-block" src="https://www.koolreport.com/assets/images/editor/c5/image6561946dbfba3.png"/>
            <img class="img-fluid rounded d-block d-sm-none" src="https://www.koolreport.com/assets/images/editor/c5/image6561946dbfba3.png"/>
        </a>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <p>
                ...
                This framework focuses strongly on creating dashboard fast and easy.
                Since it is built on top of KoolReport Pro, this framework inheriates all advanced capabilities from KoolReport Pro.
                Plus it is added various cool features specific for dashboard construction.
            </p>
            <h1>Features</h1>
            <ol>
                ...
                <li>Support Data Caching at widget level</li>
                <li>Support multi-languages</li>
                <li>Support Multi-themes</li>
            ...
            <p>
                Since Dashboard is built on top of KoolReport Pro so it is sold as an add-on of KoolReport Pro.
                Dashboard has 3 licenses types:
            </p>
            <ul>
                <li>Developer License <b>$99</b></li>
